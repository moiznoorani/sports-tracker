...
public struct MainTabView: View {
    ...
    init(authVM: AuthViewModel, profileVM: ProfileViewModel, leagueVM: LeagueViewModel,
         tournamentVM: TournamentViewModel, userId: String) {
        self.authVM = authVM
    ...
    public var body: some View {
        TabView {
            Tab("Leagues", systemImage: "sportscourt") {
                LeaguesView(vm: leagueVM, tournamentVM: tournamentVM, userId: userId)
            }
